// C program to create a bank account system
#include <stdio.h>
#include <stdlib.h>
#include <string.h>
#include <windows.h>
    ...
    int main()
        {
            ...
            printf("DEVELOPER-Ronald Osondu");
            gotoxy(20, 10);
...
// Function to transfer money from one user to another
	...
	// to write amount along with username to which amount is going to be transferred
	fm = fopen("mon.txt", "a");
	gotoxy(33, 4);
	...
	// Checking for username if itis present in file or not
	while (fread(&u1, sizeof(u1),1, fp))
